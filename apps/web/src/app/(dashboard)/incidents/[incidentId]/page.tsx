        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm">
              Detected {formatDate(incident.detected_at)} / fingerprint{" "}
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_24rem]">
        <div className="flex flex-col gap-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Durable incident events. Agent, Slack, and GitHub actions will
                append here next.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Raw PostHog signals attached to this incident.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-4">
        ...
        <Card className="h-fit">
          <CardHeader>
            ...
            <CardDescription>
              The minimal record future workers will consume.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-3 text-sm">
            ...
            <DetailRow label="Resolved" value={incident.resolved_at ? formatDate(incident.resolved_at) : "Open"} />
            <Separator />
      ...
      <CardContent className="flex flex-col gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {signal.source_event_id && (
            <Badge variant="outline">{signal.source_event_id}</Badge>
          )}
        </div>
