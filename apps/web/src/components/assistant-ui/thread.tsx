...
const bellaCommandOptions = [
  {
    id: "summary",
    description: "Summarize recent AI spend",
    icon: "BarChart3",
    prompt: "Summarize AI spend for the last 30 days",
  },
  {
    id: "providers",
    description: "Break down spend by provider",
    icon: "PieChart",
    prompt: "Break down spend by provider",
  },
  {
    id: "models",
    description: "Show model usage and spend",
    icon: "Table2",
    prompt: "Break down spend and usage by model",
  },
  {
    id: "sync",
    description: "Check provider sync freshness",
    icon: "RefreshCw",
    prompt: "Check provider sync freshness",
  },
  {
    id: "help",
    description: "List available Bella commands",
    icon: "HelpCircle",
    prompt:
...
const ComposerAction: FC = () => {
  const { ComposerAccessory } = useContext(ThreadComponentsContext);
